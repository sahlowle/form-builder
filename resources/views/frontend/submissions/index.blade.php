            ...
            <div class="card rounded-0">
                <div class="card-header">
                    <h5 class="card-title">
                        ...
                        <a href="{{ route('frontend.forms.index') }}" class="btn btn-primary float-md-right btn-sm">
                            ...
                            <tbody>
                                @foreach($submissions as $submission)
                                    <tr>
                                        ...
                                        @endforeach
                                        <td>
                                            <a href="{{ route('frontend.forms.submissions.show', [$form, $submission->id]) }}" class="btn btn-primary btn-sm" title="View submission">
                                                <i class="fa fa-eye"></i> View
                                            </a> 

                                            <form action="{{ route('frontend.forms.submissions.destroy', [$form, $submission]) }}" method="POST" id="deleteSubmissionForm_{{ $submission->id }}" class="d-inline-block">
                                                @csrf 
                                                @method('DELETE')

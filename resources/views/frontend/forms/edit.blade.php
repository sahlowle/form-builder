    ...
    <div class="row justify-content-center">
        <div class="col-md-10">
            <div class="card">
                    ...
                    <h5 class="card-title">
                        ...
                        <div class="btn-toolbar float-md-right" role="toolbar">
                            <div class="btn-group" role="group">
                                <a href="{{ route('frontend.forms.index') }}" class="m-2 btn btn-sm btn-primary float-md-right">
                                    <i class="fa fa-arrow-left"></i> Back To My Forms
                                </a>
                                <button class="m-2 btn btn-primary btn-sm clipboard" data-clipboard-text="{{ route('frontend.form.render', $form->identifier) }}" data-message="Link Copied" data-original="Copy Form Link" title="Copy form URL to clipboard">
                ...
                <form action="{{ route('frontend.forms.update', $form) }}" method="POST" id="createFormForm" data-form-method="PUT">
                    @csrf 
                    @method('PUT')
...
@push( 'scripts')
    ...
    <script src="{{ asset('formbuilder/js/create-form.js') }}{{ App\Helper::bustCache() }}" defer></script>
@endpush

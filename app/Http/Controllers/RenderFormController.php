...
class RenderFormController extends Controller
{
    ...
    public function render($identifier)
    {
        ...
        return view('frontend.render.index', compact('form', 'pageTitle'));
    }
    ...
    public function submit(Request $request, $identifier)
    {
        ...
        try {
            ...
            return redirect()
                    ->route('frontend.form.feedback', $identifier)
    ...
    public function feedback($identifier)
    {
        ...
        return view('frontend.render.feedback', compact('form', 'pageTitle'));
    }
}

...
class SubmissionController extends Controller
{
    ...
    public function show($form_id, $submission_id)
    {
        ...
        return view('frontend.submissions.show', compact('pageTitle', 'submission', 'form_headers'));
    }
    ...
    public function destroy($form_id, $submission_id)
    {
        ...
        return redirect()
                    ->route('frontend.forms.submissions.index', $form_id)

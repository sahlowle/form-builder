...
class MySubmissionController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('frontend.my_submissions.index', compact('submissions', 'pageTitle'));
    }
    ...
    public function show($id)
    {
        ...
        return view('frontend.my_submissions.show', compact('submission', 'pageTitle', 'form_headers'));
    }
    ...
    public function edit($id)
    {
        ...
        return view('frontend.my_submissions.edit', compact('submission', 'pageTitle'));
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        try {
            ...
            return redirect()
                        ->route('frontend.my-submissions.index')
